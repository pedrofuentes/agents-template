...
- Changes to `template/AGENTS.md` may need syncing to downstream projects (gitnotate, Arbol, Council, stream-deck-ical, stream-deck-github-utilities, stream-deck-cloudflare-utilities)
