...
- NEVER section: add `release-generated CHANGELOG` to the generated files list
...
4. Commit: `chore: migrate to agents-template v0.13.0`
...
**Automated release tooling**: If `release-please-config.json`, `.releaserc*`, `.changeset/config.json`, or similar is detected:
- In Associated Documentation, change CHANGELOG.md from `**Update** — user-facing changes` to `**Read only** — auto-generated by [tool name]`
- In the NEVER section, add `release-generated CHANGELOG` to the generated files list
...
5. Commit: `chore: configure AGENTS.md (agents-template v0.13.0)`
<!-- SETUP:END -->
...
<!-- Release tooling (Release Please, semantic-release, Changesets): change "Update" above to "Read only — auto-generated by [tool]" and add release-generated CHANGELOG to generated files in NEVER -->
