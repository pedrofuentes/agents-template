...
- Release tooling (Release Please, semantic-release, Changesets) — check for config files and workflow actions
...
**Automated release tooling**: If release tooling is detected (from Step M2), adjust:
- Associated Documentation: CHANGELOG.md → `**Read only** — auto-generated by [tool name]`
- NEVER §Integrity bullet: change `hand-edit generated files (build artifacts, lockfiles)` to `hand-edit generated files (build artifacts, lockfiles, release-generated CHANGELOG)`
- If existing agent docs already mark CHANGELOG as generated or read-only, preserve that rule
...
4. Commit: `chore: migrate to agents-template v0.23.0`
...
- `.github/workflows/*` → CI system, release automation (e.g., `googleapis/release-please-action`)
...
**Automated release tooling**: If any release-tooling config from Step 1 is detected:
- In Associated Documentation, change CHANGELOG.md from `**Update** — user-facing changes` to `**Read only** — auto-generated by [tool name]`
- In the NEVER §Integrity bullet, change `hand-edit generated files (build artifacts, lockfiles)` to `hand-edit generated files (build artifacts, lockfiles, release-generated CHANGELOG)`
...
- "Which Sentinel invocation method? (A=sub-agent, B=CI, C=manual)" → if B, set up CI to invoke Sentinel with docs/SENTINEL.md as system prompt and gate merges on its Status: line
...
5. Commit: `chore: configure AGENTS.md (agents-template v0.23.0)`
<!-- SETUP:END -->
