...
4. Commit: `chore: migrate to agents-template v0.10.0`
...
5. Commit: `chore: configure AGENTS.md (agents-template v0.10.0)`
<!-- SETUP:END -->
...
2. `{{PACKAGE_MANAGER}} test` — full suite green on final HEAD
3. `{{PACKAGE_MANAGER}} lint` — zero warnings
